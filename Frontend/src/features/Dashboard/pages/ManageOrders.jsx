...
const ManageOrders = () => {
  ...
  const orders = [
    { id: '#ORD-7231', customerName: 'Rahul Sharma', customerEmail: 'rahul@example.com', date: 'May 10, 2024', status: 'Delivered', total: 4999, paymentStatus: 'Paid' },
    { id: '#ORD-7230', customerName: 'Priya Singh', customerEmail: 'priya@example.com', date: 'May 10, 2024', status: 'Pending', total: 2499, paymentStatus: 'Awaiting' },
    { id: '#ORD-7229', customerName: 'Amit Verma', customerEmail: 'amit@example.com', date: 'May 09, 2024', status: 'Shipped', total: 3299, paymentStatus: 'Paid' },
    { id: '#ORD-7228', customerName: 'Sneha Kapur', customerEmail: 'sneha@example.com', date: 'May 09, 2024', status: 'Processing', total: 1899, paymentStatus: 'Paid' },
    { id: '#ORD-7227', customerName: 'Vikram Malhotra', customerEmail: 'vikram@example.com', date: 'May 08, 2024', status: 'Delivered', total: 5499, paymentStatus: 'Paid' },
    { id: '#ORD-7226', customerName: 'Anjali Gupta', customerEmail: 'anjali@example.com', date: 'May 08, 2024', status: 'Cancelled', total: 0, paymentStatus: 'Refunded' },
  ];
  ...
  return (
    <div className="min-h-screen bg-[#FBF9F6] p-4 md:p-12 max-w-[1600px] mx-auto animate-in fade-in slide-in-from-bottom-4 duration-1000">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
        <div>
          <p className="text-[10px] font-bold uppercase tracking-[0.3em] text-gold mb-2">Operations</p>
          <h1 className="text-5xl font-serif text-slate-900 leading-tight">Order <br /> Logistics</h1>
        </div>
      ...
      <div className="bg-white/50 backdrop-blur-md p-6 rounded-3xl border border-amber-100/50 shadow-luxury mb-10">
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-4 overflow-x-auto pb-2 lg:pb-0 no-scrollbar">
            {['All Orders', 'Processing', 'Shipped', 'Delivered'].map((label) => (
              <button 
                key={label}
