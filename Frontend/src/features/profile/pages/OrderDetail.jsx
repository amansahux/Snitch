  ...
  if (!order) {
    return (
      <div className="min-h-screen bg-[#fbf9f6] flex flex-col items-center justify-center p-6 text-center">
        ...
        <h2 className="font-serif text-3xl mb-4 text-[#1b1c1a]">
          Order not found
        </h2>
        <button
      ...
      <header className="sticky top-0 z-[100] bg-[#fbf9f6]/80 backdrop-blur-2xl border-b border-[#e6dfd5]/30 px-6 lg:px-16 py-6 transition-all duration-500">
        <div className="max-w-[1200px] mx-auto flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-4">
            ...
            <span className="text-[11px] font-bold font-mono text-[#1b1c1a]">
            ...
            <section className="bg-white rounded-[3rem] p-10 lg:p-12 border border-[#e6dfd5]/20 shadow-sm">
              ...
              <div className="space-y-0 relative">
                ...
                <motion.div
                  ...
                  animate={{
                    height:
                      getStatusStep(order.orderStatus) === 0
                        ? "0%"
                ...
                {[
                  {
                    label: "Order Placed",
                    note: new Date(order.createdAt).toLocaleString("en-US", {
                      month: "short",
                      day: "numeric",
                      year: "numeric",
                      hour: "2-digit",
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="space-y-1">
                        ...
                        <p className="text-xs text-[#7a6e63] font-medium tracking-wide">
                          {step.note}
                        </p>
                      </div>
                    </div>
                  ...
                  >
                    ...
                    <div className="flex-1 flex flex-col justify-between py-2">
                      <div className="space-y-4">
                        ...
                        <div className="flex flex-wrap gap-x-8 gap-y-2">
                          <div className="flex items-center gap-2">
                            <span className="text-[10px] font-bold text-[#7a6e63]">
                              Size:
                            </span>
                      ...
                      <div className="pt-6 border-t border-[#f3eee8] flex justify-between items-center">
                        <span className="text-[10px] font-black uppercase tracking-widest text-[#7a6e63]">
                          Qty: {item.quantity}
                        </span>
                      </div>
                    </div>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-sm leading-relaxed text-[#7a6e63]">
                    ...
                    <br />
                    <span className="italic text-[#d0c5b5]">
