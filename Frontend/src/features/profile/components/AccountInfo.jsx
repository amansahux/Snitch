      ...
      <div className="grid gap-12 lg:grid-cols-2">
        <div className="space-y-8 bg-white border border-[#e6dfd5] rounded-[3rem] p-10 shadow-[0_18px_40px_rgba(27,28,26,0.02)]">
          <div className="flex items-center gap-6 pb-8 border-b border-[#f3eee8]">
            ...
            <div>
              <p className="text-[10px] font-black uppercase tracking-[0.3em] text-[#C9A96E] mb-1">
                Account Tier
              </p>
              <p className="text-xl font-serif text-[#1b1c1a] uppercase tracking-widest">
                {user?.role || "Member"}
              </p>
            </div>
          </div>
          ...
          <div className="space-y-6">
            <div className="space-y-1">
              <p className="text-[9px] font-black uppercase tracking-[0.2em] text-[#7a6e63]">
                Full Name
              </p>
