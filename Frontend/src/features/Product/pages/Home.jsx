    ...
    <>
      <div className="min-h-screen selection:bg-[#C9A96E]/30 selection:text-black bg-[#fbf9f6] font-inter no-scrollbar overflow-x-hidden">
            ...
            <div className="grid lg:grid-cols-12 gap-12 lg:gap-20 items-center">
              ...
              <div className="lg:col-span-12 xl:col-span-5 order-2 xl:order-1 space-y-8 animate-in fade-in slide-in-from-left-8 duration-1000">
                <div className="inline-flex items-center gap-3">
                  ...
                  <span className="text-[10px] sm:text-[11px] font-black uppercase tracking-[0.4em] text-gold">New Season Drop</span>
                </div>
                
                <h1 className="text-6xl sm:text-7xl lg:text-8xl font-serif text-charcoal leading-[0.9] tracking-tight">
                  Curated <span className="italic font-light">Luxury</span> <br /> 
                  For Modern <br /> 
                ...
                <p className="max-w-md text-charcoal-light text-base sm:text-lg font-light leading-relaxed">
                  Discover refined essentials crafted for elegance, confidence, and timeless presence. 
                  Every piece is a testament to the art of minimalist perfection.
                </p>
                ...
                <div className="pt-12 grid grid-cols-2 gap-8 border-t border-charcoal/5">
                    <div>
                        ...
                        <p className="text-[9px] uppercase tracking-widest text-charcoal-light mt-1">Premium Origin</p>
                    </div>
                    <div>
                        <p className="text-xl font-serif text-charcoal">Atelier</p>
                        <p className="text-[9px] uppercase tracking-widest text-charcoal-light mt-1">Global Shipping</p>
                    </div>
                </div>
              </div>
                ...
                <div className="relative group">
                  ...
                  <div className="absolute -bottom-10 -left-10 hidden xl:block animate-in fade-in zoom-in duration-1000 delay-500">
                    <div className="bg-white/80 backdrop-blur-xl p-8 rounded-[2rem] shadow-luxury border border-white/20">
                      <p className="text-[9px] font-black uppercase tracking-[0.3em] text-gold mb-2">Authenticated</p>
                      <p className="text-lg font-serif text-charcoal leading-tight">Hand-picked <br />Excellence</p>
                      <div className="mt-4 flex -space-x-3">
                        {[1, 2, 3].map(i => (
                          <div key={i} className={`w-8 h-8 rounded-full border-2 border-white bg-[#f3eee8] overflow-hidden`}>
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-20">
              <div className="space-y-4 max-w-xl">
                 <div className="inline-flex items-center gap-3">
                  ...
                  <span className="text-[10px] font-black uppercase tracking-[0.4em] text-gold">COLLECTION</span>
                </div>
                ...
                <p className="text-charcoal-light font-light text-base sm:text-md">
                   Our latest curated drops, selected for their impeccable craft and unique silhouettes.
                </p>
              </div>
            ...
            <div className="relative">
              {loading ? (
                ...
                <div className="py-32 rounded-3xl border border-dashed border-charcoal/5 bg-cream/30 flex flex-col items-center justify-center text-center px-6">
                  ...
                  <h3 className="text-3xl font-serif text-charcoal">No Pieces Found</h3>
                  <p className="mt-4 text-charcoal-light max-w-sm font-light">
                    Our current archives are momentarily empty. <br /> Check back for our next curated drop.
                  </p>
                  <button
                    onClick={() => handleGetAllProducts()}
        ...
        <footer className="bg-charcoal text-white py-24 rounded-t-[4rem] sm:rounded-t-[6rem] relative z-10 -mt-20 overflow-hidden">
          {/* Decorative Grid BG */}
          <div className="absolute inset-0 opacity-[0.03] pointer-events-none" style={{ backgroundImage: 'radial-gradient(#C9A96E 1px, transparent 1px)', backgroundSize: '40px 40px' }}></div>
          
          <div className="max-w-7xl mx-auto px-6 sm:px-12 lg:px-20 relative z-20">
            <div className="grid lg:grid-cols-12 gap-16 lg:gap-20">
              {/* Brand Col */}
              <div className="lg:col-span-5 space-y-8">
                <Link to="/" className="text-4xl font-serif tracking-[0.4em] uppercase text-gold block">
                  Snitch.
                </Link>
                <p className="max-w-xs text-white/40 text-sm font-light leading-relaxed tracking-wide">
                  Architects of contemporary style. We curate, craft, and celebrate the art of modern minimalism.
                </p>
              ...
              <div className="lg:col-span-3 space-y-8">
                <h4 className="text-[10px] uppercase tracking-[0.4em] font-black text-white/20">Discovery</h4>
                <ul className="space-y-4">
                  <li><a href="#" className="text-white/60 hover:text-gold transition-colors text-sm font-light tracking-widest">New Arrivals</a></li>
                  <li><a href="#" className="text-white/60 hover:text-gold transition-colors text-sm font-light tracking-widest">All Collections</a></li>
                  <li><a href="#" className="text-white/60 hover:text-gold transition-colors text-sm font-light tracking-widest">The Atelier</a></li>
                  <li><a href="#" className="text-white/60 hover:text-gold transition-colors text-sm font-light tracking-widest">Limited Drops</a></li>
                </ul>
              </div>

              {/* Links Col 2 */}
              <div className="lg:col-span-4 space-y-8">
                 <h4 className="text-[10px] uppercase tracking-[0.4em] font-black text-white/20">The House</h4>
                 <div className="space-y-4">
                    ...
                    <a href="mailto:atelier@snitch.studio" className="block text-gold text-sm font-serif italic border-b border-gold/10 w-fit pb-1 hover:border-gold transition-all duration-300">
